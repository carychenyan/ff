...
'<tr>' +
	...
	'<td>' +
	    '<div class="lcui_head">' +
			...
			'<tr>' +
			    '<td width="27"><a class="cui_pm" href="javascript:void(0);"><i class="icon_arrLeft"></i></a></td>' +
				'<td width="40"><input class="cui_im" maxlength="4" value=""/>月</td>' +
				'<td width="32"><a class="cui_nm" href="javascript:void(0);"><i class="icon_arrRight"></i></a></td>' +
				'<td width="27"><a class="cui_py" href="javascript:void(0);"><i class="icon_arrLeft"></i></a></td>' +
				'<td width="60"><input class="cui_iy" maxlength="4" value=""/>年</td>' +
				'<td width="22"><a class="cui_ny" href="javascript:void(0);"><i class="icon_arrRight"></i></a></td>' +
			'</tr>' +
			'</table>' +
		...
		'<div class="cui_foot">' +
			...
			'</table>' +
		'</div>' +
        '<div class="cui_footToday">' +
        '<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td align="center" class="lcui_today"><a class="cui_dbtnB" href="javascript:void(0);">\u6E05\u7A7A</a></td><td align="center" class="lcui_time"><a class="cui_tbtnB" href="javascript:void(0);">今天</a></td><td align="center" class="lcui_empty"><a class="cui_closebtn" href="javascript:void(0);">关闭</a></td></tr></table>' +
        '</div>' +
	'</td>' +
	'<td class="lcui_r"></td>' +
'</tr>' +
...
(function(head){
	...
	link.href = _path + '../css/lhgcalendar.css';
    link.rel = 'stylesheet';
...
lhgcalendar.fn = lhgcalendar.prototype =
{
	...
	_init: function( config )
	{
		...
		if (!config.hasTime) {
		    DOM.foot[0].style.display = 'none';
		    DOM.footToday[0].style.display = '';
		}
		else {
		    DOM.foot[0].style.display = '';
		    DOM.footToday[0].style.display = 'none';
		}
