...
var flashvars = {
    f: 'http://172.16.0.3/html/front_end/doc/assets/js/ckplayer/名词单数变复数.mp4',//视频地址
    a: '',//调用时的参数，只有当s>0的时候有效
    s: '0',//调用方式，0=普通方法（f=视频地址），1=网址形式,2=xml形式，3=swf形式(s>0时f=网址，配合a来完成对地址的组装)
    c: '0',//是否读取文本配置,0不是，1是
    x: '',//调用xml风格路径，为空的话将使用ckplayer.js的配置
    i: 'http://www.ckplayer.com/images/loadimg2.jpg',//初始图片地址
    d: 'http://172.16.0.3/html/front_end/doc/assets/js/ckplayer/loading.jpg',//暂停时播放的广告，swf/图片,多个用竖线隔开，图片要加链接地址，没有的时候留空就行
    u: '',//暂停时如果是图片的话，加个链接地址
    l: 'http://172.16.0.3/html/front_end/doc/assets/js/ckplayer/loading.jpg',//前置广告，swf/图片/视频，多个用竖线隔开，图片和视频要加链接地址
...
swfobject.embedSWF('http://172.16.0.3/html/front_end/doc/assets/js/ckplayer/ckplayer.swf', 'a1', '600', '400', '10.0.0', 'http://172.16.0.3/html/front_end/doc/assets/js/ckplayer/expressInstall.swf', flashvars, params, attributes);
