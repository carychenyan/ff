...
(function () {
    ...
    function insertSearch(id, catchRemote) {
        ...
        for (var i = 0, ci; ci = imgs[i++];) {
            if (ci.getAttribute("selected")) {
                ...
                img.data_ue_src = setImageSize(url, "650");
                imgObjs.push(img);
            }
        }
        insertImage(imgObjs);
    ...
    function insertBatch() {
        ...
        for (var i = 0, ci; ci = imageUrls[i++];) {
            ...
            tmpObj.data_ue_src = tmpObj.src = editor.options.imagePath + setImageSize(ci.url, "650");
            imgObjs.push(tmpObj);
        }
        insertImage(imgObjs);
        hideFlash();
    ...
    */
    function getAlbumImages() {
        ...
        function showImages(data) {
            g("imageList").innerHTML = !data.length ? "&nbsp;&nbsp;" + lang.noUploadImage : "";
            //去除空格
            for (var k = 0; k < data.length; k++) {
                ...
                img.setAttribute(k < 35 ? "src" : "lazy_src", editor.options.imageManagerPath + data[k].photo_path);
                img.setAttribute("data_ue_src", editor.options.imageManagerPath + data[k].photo_path);

            }
        }
        AjaxForJson(commonParams.dodoDevPath + "/Album/ajaxPhoto", requestData, showImages, null, null);
    }
