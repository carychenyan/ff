...
UE.plugins['music'] = function () {
    ...
    function creatInsertStr(url, width, height, align, toEmbed, addParagraph, toUpload) {
        ...
        if (toUpload == "true") {
            ...
            (addParagraph ? ('<p ' + (align != "none" ? (align == "center" ? ' style="text-align:center;" ' : ' style="float:"' + align) : '') + '>') : '') +
                ...
                (addParagraph ? '</p>' : '')
      :
      '<object toUpload="' + toUpload + '" data="' + commonParams.dodoDevPath + '/statics/dewplayer/dewplayer-vol.swf" width="' + width + '" height="' + height + '" name="dewplayer" id="dewplayer" type="application/x-shockwave-flash">' +
  '<param name="movie" value="' + commonParams.dodoDevPath + '/statics/dewplayer/dewplayer-vol.swf" />' +
  ...
  '</object>';
            ...
            (addParagraph ? ('<p ' + (align != "none" ? (align == "center" ? ' style="text-align:center;" ' : ' style="float:"' + align) : '') + '>') : '') +
                ...
                (addParagraph ? '</p>' : '')
            :
            '<embed toUpload="' + toUpload + '" type="application/x-shockwave-flash" class="edui-faked-music" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
                ' src="' + url + '" width="' + width + '" height="' + height + '" align="' + align + '"' +
...
(function () {
    ...
    var dialogBtns = {
        ...
        ok: ['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'highlightcode', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background', 'spechars']
