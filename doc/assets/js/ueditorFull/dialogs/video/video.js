    ...
    function insertSearch(id){
        ...
        for (var i = 0; i < checkId.length; i++) {
            ...
            if (checkId[i].getAttribute("is_share") > 0) {
                videoObjs.push({
                    url: commonParams.dodoDevPath + "/Disk/viewVideo/disk_id/" + videoParams.diskId + "/fid/" + fileId,
                    width: 420,
                    height: 280,
                    align: "none"
                });
...
' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" ></embed>';
    ...
    */
    function getVideoFiles() {
        var requestUrl = commonParams.dodoDevPath + "/disk/videoList";
    ...
    function initFileHTML() {
        ...
        var requestUrl = commonParams.dodoDevPath + "/disk/videoList?type=video";
