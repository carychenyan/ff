...
(function () {
    ...
    URL = commonParams.dodoDevPath + "/statics/ueditorAll/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        , toolbars: [
            ['morefunction', 'fontfamily', 'fontsize', 'undo', 'redo', 'bold', 'italic', 'underline', 'forecolor', 'backcolor', 'removeformat', 'link', 'emotion', 'insertimage', 'scrawl', 'insertvideo', 'music', 'attachment', 'spechars', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', 'insertorderedlist', 'insertunorderedlist', 'anchor']
        ]
